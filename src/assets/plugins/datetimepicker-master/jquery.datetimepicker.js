		...
		createDateTimePicker = function (input) {
			...
			calendar
				.on('touchend click.xdsoft', 'td', function (xdevent) {
					...
					if (options.selectedDateEvent &&	$.isFunction(options.selectedDateEvent)) {
						options.selectedDateEvent.call(datetimepicker, _xdsoft_datetime.currentTime, datetimepicker.data('input'), xdevent);
					}
