 ...
 *
 * @example
 * someCollection.open().disabled(true);
 *
...
define(
  ...
  function (Tools, Selector, Class) {
    ...
    proto = {
       ...
       * @return {tinymce.ui.Collection} Current collection instance.
       */
      // open: function() {}, -- Generated by code below
    ...
    Tools.each('fire on off open hide append prepend before after reflow'.split(' '), function (name) {
      proto[name] = function () {
  ...
  function (document, window, DomQuery, Delay, DomUtils, Movable, Panel, Resizable) {
    ...
    var FloatPanel = Panel.extend({
      ...
      init: function (settings) {
        ...
        self.on('postrender open', function (e) {
          if (e.control == self) {
    ...
    return Widget.extend({
      ...
      showMenu: function () {
        ...
        if (!self.menu) {
          ...
          self.menu.on('open hide', function (e) {
